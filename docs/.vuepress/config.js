module.exports = {
  title: 'MARYTWIKI',
  description: 'A MARYT PLAYER WIKI',
  markdown: {
  ...
  base: '/MARTYWIKI/', // 这是部署到github相关的配置
  themeConfig: {
    ...
    nav:[ // 导航栏配置
      ...
      items: [
            { text: '管理组创建', 
            items: [ 
            { text: 'M镇', link: '/organize/maryt/' },
            { text: '麦阿尼动画', link: '/organize/marytanima/' },
            { text: 'Betatester', link: '/organize/betatester/' },
           ] 
          },
            { text: '玩家创建', 
            items: [
            { text: '东风村', link: '/organize/dfcun/' },
            { text: '新手村', link: '/organize/xscun/' },
            { text: '长湖', link: '/organize/changhu/' },
            { text: '桃源乡', link: '/organize/tyxiang/' },
            { text: '广场镇', link: '/organize/gczhen/' },
            { text: '辉针城', link: '/organize/hzcheng/' },
            { text: '梦翎', link: '/organize/mengling/' },
           ] 
           }
          ]
      },
      ...
      {text: '支持MARYT', link: 'https://afdian.net/@maryt'},
